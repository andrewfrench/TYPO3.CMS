...
class Standard_action_SystemInformationDropDown_a90835f74eb5c6a447c772edfda524aa623a54b3 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$renderChildrenClosure174 = $arguments173['value'] ? function() use ($arguments173) { return $arguments173['value']; } : $renderChildrenClosure174;
...
$renderChildrenClosure121 = $arguments120['subject'] ? function() use ($arguments120) { return $arguments120['subject']; } : $renderChildrenClosure121;$array119['0'] = TYPO3Fluid\Fluid\ViewHelpers\CountViewHelper::renderStatic($arguments120, $renderChildrenClosure121, $renderingContext);
$array119['1'] = ' > 0';

$expression123 = function($context) {return (($context["node0"]) > 0);};
...
$expression93 = function($context) {return ($context["node0"]);};
...
$renderChildrenClosure115 = $arguments114['value'] ? function() use ($arguments114) { return $arguments114['value']; } : $renderChildrenClosure115;
