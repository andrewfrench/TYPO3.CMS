...
class partial_Extensions_1aa06305299436d5f4cf3ffab6c3ee15a610dfba extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$renderChildrenClosure52 = $arguments51['value'] ? function() use ($arguments51) { return $arguments51['value']; } : $renderChildrenClosure52;
...
$renderChildrenClosure33 = $arguments32['value'] ? function() use ($arguments32) { return $arguments32['value']; } : $renderChildrenClosure33;
...
$expression65 = function($context) {return (($context["node0"]) == FALSE);};
