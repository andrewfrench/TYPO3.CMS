...
class About_action_index_29c1681caa75784196ca2d12334b4025a25ecb6b extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$renderChildrenClosure35 = $arguments34['subject'] ? function() use ($arguments34) { return $arguments34['subject']; } : $renderChildrenClosure35;$array33['0'] = TYPO3Fluid\Fluid\ViewHelpers\CountViewHelper::renderStatic($arguments34, $renderChildrenClosure35, $renderingContext);
$array33['1'] = ' > 1';

$expression37 = function($context) {return (($context["node0"]) > 1);};
...
$arguments12['key'] = 'LLL:EXT:lang/Resources/Private/Language/locallang_core.xlf:warning.header';
...
$output0 .= TYPO3Fluid\Fluid\ViewHelpers\RenderViewHelper::renderStatic($arguments62, $renderChildrenClosure63, $renderingContext);
...
$output0 .= TYPO3Fluid\Fluid\ViewHelpers\RenderViewHelper::renderStatic($arguments65, $renderChildrenClosure66, $renderingContext);
...
$output0 .= TYPO3Fluid\Fluid\ViewHelpers\RenderViewHelper::renderStatic($arguments68, $renderChildrenClosure69, $renderingContext);
...
$output0 .= TYPO3Fluid\Fluid\ViewHelpers\RenderViewHelper::renderStatic($arguments71, $renderChildrenClosure72, $renderingContext);
...
$output0 .= TYPO3Fluid\Fluid\ViewHelpers\RenderViewHelper::renderStatic($arguments74, $renderChildrenClosure75, $renderingContext);
...
$output0 .= TYPO3Fluid\Fluid\ViewHelpers\RenderViewHelper::renderStatic($arguments77, $renderChildrenClosure78, $renderingContext);
...
$arguments80['key'] = 'LLL:EXT:lang/Resources/Private/Language/locallang_alt_intro.xlf:endText';
